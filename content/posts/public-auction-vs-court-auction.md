...
문의·상담할 때 **사이트 이름**만 다르고 「감정가」라는 단어는 같아서 혼동하는 경우가 많습니다. **조회처·매각 주체·회차 규칙**부터 나눠 읽는 편이 안전합니다.
...
법원경매에서 **최저가·회차**에 익숙한 상태로 온비드 물건을 처음 보면, **유찰·가격 하향** 규칙이 법원과 **다를 수** 있습니다. 공고문을 먼저 읽고, 평가액 명칭은 비슷해도 **산정 맥락**은 별도로 봐야 합니다. [경매 감정가 글](/posts/auction-appraisal-price-guide/)의 「세 숫자」를 공매 **입찰 안내**와 대조해 두면 혼동이 줄어듭니다.

### 상황 2: 같은 단지—법원·공매 동시 검색

아파트 한 단지에 **법원 물건**과 **공매 물건**이 각각 있으면, 감정가를 **나란히**만 비교하기 위험합니다. **권리·점유·회차**가 물건마다 다르고, 일반 매매 감정과도 **목적**이 다를 수 있습니다. 사이트 URL·입찰일·평가액을 **물건별로 분리**해 메모하는 편이 낫습니다.

### 상황 3: 상속재산 처분—공매 매각 검토

상속인이 **공매**로 부동산 처분을 검토할 때, 「시가」와 평가액을 한 숫자로 묶기 쉽습니다. [상속 평가 순서](/posts/official-price-inheritance-tax-filing/)와 **매각 가액**은 별개이고, 상속 **신고용** 감정과 **매각용** 참고가 다를 수 있습니다. 의뢰·검토 시 **목적**을 먼저 정리해 두는 편이 안전합니다.
