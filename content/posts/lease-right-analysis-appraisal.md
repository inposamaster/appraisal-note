...
접수에서는 **목적**(상속 신고·분쟁·순자산)과 **임대 유무**를 먼저 맞춥니다. 「집값만」으로 의뢰했다가 조사 중 **계약서·확정일자**를 다시 요청하는 패턴이 있습니다.
...
- **읽는 법:** 등기에 없어도 **임대 관계**는 조사 대상이 될 수 있다.
- **감정평가:** 목적이 **순자산·분쟁**이면 범위가 넓어진다.
- **실무 포인트:** 의뢰 시 「임대 없음」이라고 말하기 전에 **점유**를 확인한다.
